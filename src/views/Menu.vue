  ...
  <div class="user-manage">
    <div class="query-form">
      <el-form ref="form" :inline="true" :model="queryForm">
        ...
        <el-form-item>
          <el-button type="primary" @click="getMenuList">查 询</el-button>
    ...
    <el-dialog title="菜单管理" v-model="showModal" @close="handleClose">
...
import { eventBus } from '@/main.js'; // 根据路径调整
...
export default {
  ...
  methods: {
    ...
    handleEdit(row) {
      ...
      this.$nextTick(() => { 
        // 深拷贝实现数据隔离
        this.menuForm = cloneDeep(row);
        
        //assign浅拷贝，将row对象中的属性值赋值给menuForm对象
        //Object.assign(this.menuForm, row); 
      });
    },
    async handleDel(_id) {
      await this.$api.menuSubmit({ _id, action: "delete" });
      eventBus.emit('menu-updated'); // 触发事件
